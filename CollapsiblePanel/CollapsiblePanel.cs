...
namespace CollapsiblePanel
{
    ...
    public partial class CollapsiblePanel : UserControl
    {
        ...
        void CollapsiblePanel_Load(object sender, EventArgs e)
        {
            ...
            if (_isCollapsed)
            {
                togglingImage.Image = global::CollapsiblePanel.Properties.Resources.expand_icon;
            }
            else
            {
                togglingImage.Image = global::CollapsiblePanel.Properties.Resources.collapse_icon;
            }
        }
